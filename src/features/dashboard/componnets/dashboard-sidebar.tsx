...
export function DashboardSidebar() {
    ...
    const othersMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:sagnikmypat1234567890@gmail.com",
            icon: Headphones,
        },
    ];
        ...
        <Sidebar collapsible="icon">
            <SidebarHeader className="flex flex-col gap-4 pt-4">
                <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
                    <Image src={"/logo.png"} width={24} height={24} alt="logo" className="group-data-[collapsible=icon]:hidden" />
                    <span className="group-data-[collapsible=icon]:hidden font-semibold text-lg tracking-tighter text-foreground">Reverb</span>
